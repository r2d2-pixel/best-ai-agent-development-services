...
export async function GET() {
  ...
  lines.push('');
  lines.push(`This site independently reviews ${companies.length} ${NICHE.label} services ${NICHE.providersLabel}, ranked and compared by engagement model, pricing structure, and delivery track record.`);
  lines.push('');
